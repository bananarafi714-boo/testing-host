  ...
  const dataProduct = [
    {
      ...
      name: 'Basreng',
      price: 3500,
      description: 'Basreng bakso yang diiris tipis kemudian digoreng hingga kering dan renyah. Rasanya pedas gurih.'
    },
    {
      image: 'basreng-kemasan.jpg',
      name: 'Basreng Kemasan',
      price: 3500,
      description: 'Basreng kemasan bakso yang diiris tipis lalu digoreng hingga renyah dan diberi bumbu pedas gurih.'
    },
    {
      image: 'usus-krispy.jpg',
      name: 'Usus Krispy',
      price: 3500,
      description: 'Usus krispy camilan gurih dari usus ayam yang dibersihkan, dibumbui, lalu digoreng hingga renyah'
    },
    {
      image: 'mie-gepeng.jpg',
      name: 'Mie Gepeng',
      price: 4000,
      description: 'Mie gepeng adalah camilan kering berbahan mie lebar yang digoreng renyah dan diberi bumbu gurih pedas.'
    },
    {
      image: 'seblak-kering.jpg',
      name: 'Seblak Kering',
      price: 3000,
      description: 'Seblak kering snack pedas gurih berbahan kerupuk yang dibumbui rempah khas seblak. Rasanya renyah.'
    },
    {
      image: 'kripik-pisang.jpg',
      name: 'Kripik Pisang',
      price: 6500,
      description: 'Kripik pisang yang renyah dilapisi balutan coklat dan susu manis yang lembut. Perpaduan gurih, manis.'
    }
  ];
  /* ========== DATA PRODUCT END ========== */
